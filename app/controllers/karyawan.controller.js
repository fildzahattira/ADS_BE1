...
exports.update = (req, res) => {
    ...
    .update(req.body, {
      ...
      .catch((err) => {
        res.status(500).json({
          message: err.message || "Some error occurred while updating the karyawan.",
          data: null,
        });
      });
  };
...
exports.delete = (req, res) => {
    ...
    .destroy({
      ...
      .catch((err) => {
        res.status(500).json({
          message: err.message || "Some error occurred while deleting the karyawan.",
          data: null,
        });
      });
  };
...
const { QueryTypes } = require('sequelize');
  exports.findAllC = (req, res) => {
    ...
    db.query(sql, (err, results) => {
      if (err) throw err;
      response(200, results, `Data Karyawan dan Cuti untuk Nomor Induk ${nomor_induk}`, res);
    });
  };
